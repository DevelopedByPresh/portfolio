...
const Data = ()=>{
    return(
        <div className="home__data">
         <h1 className="home__title">Precious
         ...
         <svg
            ...
            <p className="home__description">I am a Focused, Quick-learning, Skilled And Results-Oriented Front End developer with experience building websites and web Applications.</p>     
